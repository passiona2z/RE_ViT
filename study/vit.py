...
if __name__ == "__main__":
    ...
    # Model
    vit = model_without_positional_embedding.VisionTransformer(patch_vec_size=image_patches.size(2), num_patches=image_patches.size(1),
    ...
    if args.mode == 'train':
        ...
        for epoch in range(args.epochs):
            ...
            if val_acc > best_acc:
                ...
                # torch.save(vit.state_dict(), './model_with_positional_embedding.pth')
                torch.save(vit.state_dict(), './model_without_positional_embedding.pth')
